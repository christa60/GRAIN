...
def min_norm_two_vectors(v1, v2):
    v1v1 = torch.dot(v1, v1)
    v1v2 = torch.dot(v1, v2)
    v2v2 = torch.dot(v2, v2)

    denom = v1v1 + v2v2 - 2 * v1v2
    ...
    min_vec = gamma * v1 + (1 - gamma) * v2
    min_norm = torch.linalg.norm(min_vec, ord=2)
    return gamma, min_vec, min_norm
